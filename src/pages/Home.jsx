...
//               setShowHeading(true);
//               setTimeout(() => setShowProducts(true), 800);
//               dispatch(resetJustSignedIn());
//             }, 2000); // show welcome 2s
//           } else {
//             setShowHeading(true);
//             setTimeout(() => setShowProducts(true), 800);
//           }
...
//   }, [isLoading, user, justSignedIn, dispatch]);

//   // Loader screen
//   if (isLoading || showLoader) {
//     return (
//       <div
//         className={`fixed inset-0 flex items-center justify-center h-screen transition-opacity duration-700 z-50 ${fadeOut ? "opacity-0" : "opacity-100"
//           }`}
//       >
...
//         <div
//           className={`flex space-x-3 transition-opacity duration-700 ${fadeOut ? "opacity-0" : "opacity-100"
//             }`}
//         >
...
//       {/* Heading */}
//       <h2
//         className={`text-4xl font-extrabold text-gray-800 mb-8 text-center animate-slideUp 
//           ${showHeading
...
//             key={product.id}
//             style={{
//               transitionDelay: `${index * 400}ms`, // stagger each card
//             }}
